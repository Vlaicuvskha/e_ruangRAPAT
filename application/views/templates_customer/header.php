  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="<?php base_url('data_ruang');?>"><h2>e-Rapat Booking<em>.</em></h2></a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url('customer/data_ruang') ?>">Ruangan</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url('customer/transaksi') ?>">Permohonan</a>
              </li>
              <!--<li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url('auth/logout'); ?>">SELAMAT DATANG <?= $this->session->userdata('nama'); ?><span> | Logout</span></a>
              </li>
              <?php }
              else{ ?>
              <li class="nav-item">
