...
class Transaksi extends CI_Controller{
  ...
  public function index(){
    $data['transaksi'] = $this->db->query("SELECT * FROM transaksi tr, ruang mb, customer cs WHERE tr.id_ruang=mb.id_ruang AND tr.id_customer=cs.id_customer")->result();
  ...
  public function transaksi_selesai_aksi(){
    ...
    $where  = array('id_rental' => $id);
    $where2 = array('id_ruang' => $id_ruang);
